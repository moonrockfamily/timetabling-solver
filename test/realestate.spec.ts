...
describe('real estate showing scheduling', () => {
  ...
  it('No showing if homeowner unavailable', () => {
    ...
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'unavailable', constraints: [] } };
  ...
  it('GA picks slot when all parties available', () => {
    ...
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [] } };
  ...
  it('Activity constraint can restrict to "open house" type showings', () => {
    const buyer: Participant = { name: 'Buyer' };
    const agent: Participant = { name: 'Agent' };
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [new ActivityConstraint('open-house')] } };
  ...
  it('Multiple buyers compete and agent preference resolves tie', () => {
    const buyer1: Participant = { name: 'Buyer1', preference: ctx => ctx.start.getHours() < 12 ? 0.2 : 0.8 };
    const buyer2: Participant = { name: 'Buyer2', preference: ctx => ctx.start.getHours() < 12 ? 0.8 : 0.2 };
    const agent: Participant = { name: 'Agent', preference: ctx => 1 - Math.abs(ctx.start.getHours() - 10) / 10 };
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [] } };
  ...
  it('Recurring open house constrained by rrule', () => {
    ...
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [] }, rruleSet: openRule };
  ...
  it('Two buyers both have bookings that overlap with high-preference slots', () => {
    ...
    const agent: Participant = { name: 'Agent', preference: ctx => ctx.start.getHours() === 10 ? 1 : 0 };
    const homeowner: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [] } };
  ...
  it('Batch scheduling three showings respects earlier bookings', () => {
    ...
    const homeownerObj: Participant = { name: 'Homeowner', availability: { status: 'available', constraints: [] } };
    const meetings = [
